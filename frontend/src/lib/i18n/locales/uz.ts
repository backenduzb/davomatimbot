export default {
  ...
  classes: {
    ...
    promote_hint: "Yangi o'quv yili uchun barcha sinflarni bir pog'ona yuqoriga ko'chiradi (8-sinf → 9-sinf).",
    promote_confirm_title: "Sinflarni keyingi o'quv yiliga oshirish",
    promote_warning: "Diqqat! Bu amal barcha sinflarning nomini o'zgartiradi. Davom etishdan oldin quyidagi ro'yxatni tekshiring.",
    promote_count: "Oshiriladi",
    graduate_count: "Bitiruvchi",
    skip_count: "O'zgarmaydi",
    promote_changes: "O'zgarishlar",
    promote_unchanged: "O'zgarmaydigan sinflar",
    promote_acknowledge: "Men ro'yxatni tekshirdim va sinflarni oshirishga roziman",
    promote_confirm: "Ha, oshirish",
    promote_running: "Bajarilmoqda...",
    promote_success: "Muvaffaqiyatli! {promoted} ta sinf oshirildi, {graduated} ta bitiruvchi sinf o'zgarmadi.",
